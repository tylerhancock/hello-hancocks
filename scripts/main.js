...
var scroll = document.querySelector('.overflowContainer');
const maxScroll = this.scroll.scrollWidth - this.scroll.offsetWidth;

console.log(this.scroll.offsetWidth)
new Impetus(this.scroll, {
	boundX: [-maxScroll, 0],
  update: (x) => {
    if (this.scroll) {
